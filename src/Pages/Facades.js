...
class Facades extends Component {
    constructor(props)
    {
        ...
        this.whyText = <div>Компаниям: реклама, узнаваемость.
        Людям: эстетическое удовольствие от преображения внешнего вида или же
        чтобы высказать какую-то мысль и привлечь внимание других людей.</div>
